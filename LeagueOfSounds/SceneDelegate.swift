...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    var fetch = FetchVersion()
    let url = URL(string: "https://ddragon.leagueoflegends.com/cdn/10.16.1/img/champion/Aatrox.png")!
    let urls = [URL(string: "https://ddragon.leagueoflegends.com/cdn/10.16.1/img/champion/Aatrox.png")!, URL(string: "https://ddragon.leagueoflegends.com/cdn/10.16.1/img/champion/Anivia.png")!, URL(string: "https://ddragon.leagueoflegends.com/cdn/10.16.1/img/champion/AurelionSol.png")!]
